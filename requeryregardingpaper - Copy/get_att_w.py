...
Data_train = './Fold_1/Data/Whisper/'
...
F=24;
files1 = np.genfromtxt('./Fold_1/lists/train_data_w.lst', dtype='str')
list_IDs_in=[str(x) for x in files1]

inp,out=GetModel()
model=Model(inp,out);
model.load_weights('./Fold_1/Models_w/checkpoint-phn_emb-06-0.08.hdf5');
layer_name = 'lstm_1'
...
for i in range(0,len(list_IDs_in)):
    ...
    mat = ID[5:]+'.mat'
    file_path = r'C:/Users/bhavu/Downloads/Ch_classification/Fold_1/Train_Attention/Attention_whisper'+'/'+mat
